...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/10 18:48:44 by elizohin          #+#    #+#             */
/*   Updated: 2024/05/21 14:33:30 by elizohin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	is_builtin(char *str)  // permet de savoir si c'est un builtin ou pas 
{
	if (is_same(str, "cd"))
		return (1);
 ...
 // envoi les structures dans les fonctions de builtin et execute les builtins
